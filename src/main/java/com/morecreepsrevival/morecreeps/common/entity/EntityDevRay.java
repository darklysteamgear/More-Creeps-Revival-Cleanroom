...
public class EntityDevRay extends Entity implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityDevRay.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityDevRay(World worldIn)
    {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public EntityDevRay(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public EntityDevRay(World worldIn, EntityLivingBase shooter)
    {
