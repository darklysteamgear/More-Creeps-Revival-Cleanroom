...
public class ModelHunchbackSkeleton extends ModelBiped {
    public ModelHunchbackSkeleton() {
        this(0.0F, false);
    }

    public ModelHunchbackSkeleton(float modelSize, boolean p_i46303_2_) {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (itemstack.getItem() == Items.BOW && ((EntityHunchbackSkeleton) entitylivingbaseIn).isSwingingArms()) {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, @Nonnull Entity entityIn) {
        ...
        EntityHunchbackSkeleton abstractskeleton = (EntityHunchbackSkeleton) entityIn;
